...
$theme = wp_get_theme();
if ( 'EpicTrips' == $theme->name || 'EpicTrips' == $theme->parent_theme ) {
    ...
    require THEMESFLAT_PATH . "/widgets/themesflat_author_box.php";
...
function themesflat_shortcode_register_assets() {
    ...
    if ( function_exists( 'themesflat_get_opt' ) ) {
        if (themesflat_get_opt('show_animation')) {
            // wp_enqueue_style( 'animated', plugins_url('assets/css/animate.min.css', __FILE__), array(), true );
            // wp_enqueue_script( 'wow-min', plugins_url('assets/js/wow.min.js', __FILE__), array(), '1.0', true );
            // wp_enqueue_script( 'wow', plugins_url('assets/js/wow.js', __FILE__), array(), '1.0', true );

            wp_enqueue_style( 'tf-animated', plugins_url('assets/css/tf-animated.css', __FILE__), array(), true );
            wp_enqueue_script( 'tf-animated', plugins_url('assets/js/tf-animated.js', __FILE__), array(), '1.0', true );
        }
    }
...
final class ThemesFlat_Addon_For_Elementor_vitour {
    ...
    public function init() {
        ...
        $theme = wp_get_theme();
        if ( 'Vitour' == $theme->name || 'Vitour' == $theme->parent_theme ) {
        ...
        add_action( 'wp', [ $this, 'hooks' ],100 );
         ...
         add_action('elementor/element/before_section_end', function( $section, $section_id, $args ) {
            if( ($section->get_name() == 'common' && $section_id == 'section_effects') || ($section->get_name() == 'container' && $section_id == 'section_effects') || ($section->get_name() == 'colunmn' && $section_id == 'section_effects') || ($section->get_name() == 'section' && $section_id == 'section_effects') ){
    ...
    public function widget_styles() {
        ...
        wp_register_style( 'tf-flex-slider', plugins_url( '/assets/css/flex-slider/tf-flex-slider.css', __FILE__ ) );
    ...
    public function widget_scripts() {
        ...
        wp_register_script( 'tf-flex-slider', plugins_url( '/assets/js/flex-slider/tf-flex-slider.js', __FILE__ ), [ 'jquery' ], false, true );
    }
    ...
    ========================================= */
        ...
        public static function get_template_id( $type ) {
            ...
            $tfhf_templates = ThemesFlat_Addon_For_Elementor_vitour::instance()->get_posts_by_conditions( 'tf_header_footer', $option );
...
ThemesFlat_Addon_For_Elementor_vitour::instance();
