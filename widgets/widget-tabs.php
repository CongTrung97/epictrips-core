	...
	protected function register_controls() {
        // Start Tab Setting        
	        ...
	        $repeater->add_control( 'list_title', [
					...
					'default' => esc_html__( 'Bookings & Prices' , 'themesflat-core'  ),
					'label_block' => true,
				]
			);
			...
			$repeater->add_control( 'list_content', [
					...
					'default' => esc_html__( 'a) Occasionally it may be deemed necessary to make changes to your holiday and the Company reserves the right to do so at any time, and you will be notified of any changes at the earliest possible opportunity. If a major change to your tour is necessary, providing it does not arise from circumstances beyond the Company’s control, you may choose (i) to accept the change of arrangements (ii) to purchase another holiday from us or (iii) to cancel your holiday. Compensation may be payable in cases of major change as detailed below.' , 'themesflat-core'  ),
					'label_block' => true,
					'condition' => [
	        ...
	        $this->add_control( 'tab_list',
				[					
					...
					'default' => [
						[
							'list_title' => esc_html__( 'Bookings & Prices', 'themesflat-core'  ),
							'list_content' => esc_html__( 'a) Occasionally it may be deemed necessary to make changes to your holiday and the Company reserves the right to do so at any time, and you will be notified of any changes at the earliest possible opportunity. If a major change to your tour is necessary, providing it does not arise from circumstances beyond the Company’s control, you may choose (i) to accept the change of arrangements (ii) to purchase another holiday from us or (iii) to cancel your holiday. Compensation may be payable in cases of major change as detailed below.', 'themesflat-core'  ),
						],
						[
							'list_title' => esc_html__( 'Payments, Refunds & Credits', 'themesflat-core'  ),
							'list_content' => esc_html__( 'a) Occasionally it may be deemed necessary to make changes to your holiday and the Company reserves the right to do so at any time, and you will be notified of any changes at the earliest possible opportunity. If a major change to your tour is necessary, providing it does not arise from circumstances beyond the Company’s control, you may choose (i) to accept the change of arrangements (ii) to purchase another holiday from us or (iii) to cancel your holiday. Compensation may be payable in cases of major change as detailed below.', 'themesflat-core'  ),
						],
						[
							'list_title' => esc_html__( 'Changes', 'themesflat-core'  ),
							'list_content' => esc_html__( 'a) Occasionally it may be deemed necessary to make changes to your holiday and the Company reserves the right to do so at any time, and you will be notified of any changes at the earliest possible opportunity. If a major change to your tour is necessary, providing it does not arise from circumstances beyond the Company’s control, you may choose (i) to accept the change of arrangements (ii) to purchase another holiday from us or (iii) to cancel your holiday. Compensation may be payable in cases of major change as detailed below.', 'themesflat-core'  ),
						],
					],
				...
				$this->start_controls_tab( 'title_style_hover_tab',
					...
					$this->add_control( 'title_color_hover',
						[
							...
							'type' => \Elementor\Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .tf-tabs .tf-tabnav ul > li:hover .tab-title-text,{{WRAPPER}} .tf-tabs .tf-tabnav ul > li.set-active-tab .tab-title-text,
					...
					$this->add_control( 'border_title_color',
						[
							'label' => esc_html__( 'Border Color', 'themesflat-core'  ),
							'type' => \Elementor\Controls_Manager::COLOR,
							'selectors' => [
								'{{WRAPPER}} .tf-tabs.vertical .tf-tabnav ul > li:hover,{{WRAPPER}}  .tf-tabs.vertical .tf-tabnav ul > li.active,{{WRAPPER}}  .tf-tabs.vertical .tf-tabnav ul > li.set-active-tab' => 'border-color: {{VALUE}}',
							],
							'condition' => [
								'tab_type' => 'vertical',
							],
